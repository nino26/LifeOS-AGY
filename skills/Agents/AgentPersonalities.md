...
**What happens:**
1. Run `bun run ~/Projects/LifeOS-AGY/.agents/skills/Agents/Tools/ComposeAgent.ts` for EACH agent
...
- Trait definitions: `~/Projects/LifeOS-AGY/.agents/skills/Agents/Data/Traits.yaml`
- Agent template: `~/Projects/LifeOS-AGY/.agents/skills/Agents/Templates/DynamicAgent.hbs`
- Composition tool: `~/Projects/LifeOS-AGY/.agents/skills/Agents/Tools/ComposeAgent.ts`

---

## Named Agent Architecture

- **Location**: Individual agent files in `~/Projects/LifeOS-AGY/agents/*.md`
