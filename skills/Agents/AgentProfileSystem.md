...
bun run ~/Projects/LifeOS-AGY/.agents/skills/Agents/Tools/LoadAgentContext.ts Architect "Design new skill system"
```
...
1. Create `[AgentType]Context.md` in `~/Projects/LifeOS-AGY/.agents/skills/Agents/`
