...
```
~/Projects/LifeOS-AGY/.agents/skills/Agents/
...
Old YAML system backed up to: `~/Projects/LifeOS-AGY/History/Backups/2025-12-18-AgentProfiles/`
...
bun run ~/Projects/LifeOS-AGY/.agents/skills/Agents/Tools/LoadAgentContext.ts
# Output: Architect, Artist, Engineer, Designer, QATester

# View specific context
bun run ~/Projects/LifeOS-AGY/.agents/skills/Agents/Tools/LoadAgentContext.ts Architect

# Generate enriched prompt
bun run ~/Projects/LifeOS-AGY/.agents/skills/Agents/Tools/LoadAgentContext.ts Engineer "Implement TDD workflow"
```
