...
```
~/Projects/LifeOS-AGY/PAI/USER/SKILLCUSTOMIZATIONS/Agents/
...
bun run ~/Projects/LifeOS-AGY/.agents/skills/Agents/Tools/ComposeAgent.ts --task "Review security"
bun run ~/Projects/LifeOS-AGY/.agents/skills/Agents/Tools/ComposeAgent.ts --traits "security,skeptical,thorough"

# Persistent custom agents
bun run ~/Projects/LifeOS-AGY/.agents/skills/Agents/Tools/ComposeAgent.ts --task "Security review" --save
bun run ~/Projects/LifeOS-AGY/.agents/skills/Agents/Tools/ComposeAgent.ts --list-saved
bun run ~/Projects/LifeOS-AGY/.agents/skills/Agents/Tools/ComposeAgent.ts --load "security-expert-skeptical-thorough"
bun run ~/Projects/LifeOS-AGY/.agents/skills/Agents/Tools/ComposeAgent.ts --delete "security-expert-skeptical-thorough"

# Other options
bun run ~/Projects/LifeOS-AGY/.agents/skills/Agents/Tools/ComposeAgent.ts --list
bun run ~/Projects/LifeOS-AGY/.agents/skills/Agents/Tools/ComposeAgent.ts --output json
```
