...
bun run ~/Projects/LifeOS-AGY/.agents/skills/Agents/Tools/ComposeAgent.ts \
...
- ComposeAgent tool: `~/Projects/LifeOS-AGY/.agents/skills/Agents/Tools/ComposeAgent.ts`
- Voice mappings: `~/Projects/LifeOS-AGY/.agents/skills/Agents/AgentPersonalities.md`
