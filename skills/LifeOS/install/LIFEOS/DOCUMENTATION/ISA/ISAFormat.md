...
```
~/Projects/LifeOS-AGY/LIFEOS/MEMORY/WORK/{slug}/ISA.md
```
...
- **Reference file pattern**: This spec lives at `~/Projects/LifeOS-AGY/LIFEOS/DOCUMENTATION/ISA/ISAFormat.md`, not inline in CLAUDE.md. Saves ~2,500 tokens/response.
