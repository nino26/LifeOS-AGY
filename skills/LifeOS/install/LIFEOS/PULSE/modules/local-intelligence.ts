...
const CUSTOMIZATIONS_DIR = join(HOME, ".gemini/config", "LIFEOS", "USER", "CUSTOMIZATIONS", "SKILLS", "LocalIntelligence")
const LEGACY_DATA_DIR = join(HOME, ".gemini/config", "LIFEOS", "MEMORY", "DATA", "LocalIntelligence")
...
const REFRESH_SCRIPT = join(HOME, ".gemini/config", "skills", "LocalIntelligence", "Tools", "Refresh.ts")
