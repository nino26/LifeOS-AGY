...
const HOME = homedir();
const PROJECTS_MD = join(HOME, ".gemini/config/LIFEOS/USER/PROJECTS.md");
const INVENTORY_TS = join(HOME, ".gemini/config/LIFEOS/USER/CUSTOMIZATIONS/ARBOL/Shared/infra-inventory.ts");
