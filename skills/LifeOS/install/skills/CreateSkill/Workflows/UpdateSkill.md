...
```
~/Projects/LifeOS-AGY/LIFEOS/SkillSystem.md
```
...
Example:
```bash
touch ~/Projects/LifeOS-AGY/.agents/skills/_MYSKILL/Workflows/UpdatePublicRepo.md
```
...
```bash
touch ~/Projects/LifeOS-AGY/.agents/skills/[SkillName]/Tools/ToolName.ts
touch ~/Projects/LifeOS-AGY/.agents/skills/[SkillName]/Tools/ToolName.help.md
```
