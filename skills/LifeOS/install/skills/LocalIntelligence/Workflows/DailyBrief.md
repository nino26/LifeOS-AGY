...
2. Run `bun run ~/Projects/LifeOS-AGY/.agents/skills/LocalIntelligence/Tools/Refresh.ts` — orchestrator runs all eight fetchers via `Promise.allSettled`.
3. Read the resulting `~/Projects/LifeOS-AGY/LIFEOS/MEMORY/DATA/LocalIntelligence/latest.json`.
...
```bash
bun run ~/Projects/LifeOS-AGY/.agents/skills/LocalIntelligence/Tools/Refresh.ts [--force] [--summary] [--json]
```

## Output

- File: `~/Projects/LifeOS-AGY/LIFEOS/MEMORY/DATA/LocalIntelligence/<YYYY-MM-DD>_<city>_<state>_digest.json`
- Symlink: `~/Projects/LifeOS-AGY/LIFEOS/MEMORY/DATA/LocalIntelligence/latest.json`
