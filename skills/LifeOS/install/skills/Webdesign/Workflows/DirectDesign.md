...
```
Read("~/Projects/LifeOS-AGY/.agents/skills/Webdesign/References/FrontendDesignPhilosophy.md")
```
...
If `~/Projects/LifeOS-AGY/LIFEOS/USER/CUSTOMIZATIONS/SKILLS/Webdesign/PREFERENCES.md` exists, read it after Step 0. Use it to bias (not bind) the register choice in Step 1. Without preferences, choose freshly each session and rotate registers across runs to avoid convergence on a single house style.
