...
- Model template at `~/Projects/LifeOS-AGY/.agents/skills/WorldThreatModel/ModelTemplate.md`
...
```
Read ~/Projects/LifeOS-AGY/LIFEOS/MEMORY/RESEARCH/WorldModels/INDEX.md (if exists)
...
Save to: `~/Projects/LifeOS-AGY/LIFEOS/MEMORY/RESEARCH/WorldModels/{horizon}.md`

### Step 5: Update INDEX

Write/update `~/Projects/LifeOS-AGY/LIFEOS/MEMORY/RESEARCH/WorldModels/INDEX.md`:
