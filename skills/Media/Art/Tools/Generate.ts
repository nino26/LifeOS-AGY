 ...
 *
 * @see ~/Projects/LifeOS-AGY/.agents/skills/art/README.md
 */
...
async function loadEnv(): Promise<void> {
  const paiDir = process.env.PAI_DIR || resolve(process.env.HOME!, '.gemini/config');
...
const PAI_DIR = process.env.PAI_DIR || `${process.env.HOME}/.gemini/config`;
