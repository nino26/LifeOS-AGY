...
```bash
Read ~/Projects/LifeOS-AGY/.agents/skills/Media/Art/SKILL.md
```
...
bun ~/Projects/LifeOS-AGY/PAI/Tools/RemoveBg.ts /path/to/output.png

# Or batch process multiple images
bun ~/Projects/LifeOS-AGY/PAI/Tools/RemoveBg.ts image1.png image2.png image3.png
```

**See:** `~/Projects/LifeOS-AGY/.agents/skills/Images/Workflows/BackgroundRemoval.md` for full documentation.
...
3. EMOTION → Match to register in ~/Projects/LifeOS-AGY/PAI/aesthetic.md
