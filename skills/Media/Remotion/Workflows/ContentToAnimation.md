...
# Load: ~/Projects/LifeOS-AGY/.agents/skills/Parser/Workflows/ExtractYoutube.md
```
...
```typescript
import { PAI_THEME } from '~/Projects/LifeOS-AGY/.agents/skills/Remotion/theme'
...
- Load: `~/Projects/LifeOS-AGY/PAI/USER/SKILLCUSTOMIZATIONS/Art/PREFERENCES.md`
- Apply: Charcoal aesthetic, purple accents, organic animations
- Reference: `~/Projects/LifeOS-AGY/.agents/skills/Remotion/theme.ts`
