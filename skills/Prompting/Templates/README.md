...
```bash
bun run ~/Projects/LifeOS-AGY/.agents/skills/Prompting/Tools/ValidateTemplate.ts \
...
- `~/Projects/LifeOS-AGY/LIFEOS/Prompting.md` (Templating section)
...
- `~/Projects/LifeOS-AGY/.agents/skills/Evals/SKILL.md`
