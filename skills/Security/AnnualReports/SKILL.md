...
`~/Projects/LifeOS-AGY/PAI/USER/SKILLCUSTOMIZATIONS/AnnualReports/`
...
bun run ~/Projects/LifeOS-AGY/.agents/skills/Security/AnnualReports/Tools/UpdateSources.ts

# List all sources
bun run ~/Projects/LifeOS-AGY/.agents/skills/Security/AnnualReports/Tools/ListSources.ts [category]

# Fetch a specific report
bun run ~/Projects/LifeOS-AGY/.agents/skills/Security/AnnualReports/Tools/FetchReport.ts <vendor> <report-name>
```
