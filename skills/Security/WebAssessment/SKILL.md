...
`~/Projects/LifeOS-AGY/PAI/USER/SKILLCUSTOMIZATIONS/WebAssessment/`
...
bun ~/Projects/LifeOS-AGY/.agents/skills/Security/Recon/Tools/CorporateStructure.ts target.com

# Subdomain enumeration
bun ~/Projects/LifeOS-AGY/.agents/skills/Security/Recon/Tools/SubdomainEnum.ts target.com

# Endpoint discovery from JavaScript
bun ~/Projects/LifeOS-AGY/.agents/skills/Security/Recon/Tools/EndpointDiscovery.ts https://target.com

# Port scanning
bun ~/Projects/LifeOS-AGY/.agents/skills/Security/Recon/Tools/PortScan.ts target.com

# Path discovery
bun ~/Projects/LifeOS-AGY/.agents/skills/Security/Recon/Tools/PathDiscovery.ts https://target.com
```
