...
```bash
cp -r ~/Projects/LifeOS-AGY/.agents/skills/Telos/DashboardTemplate /path/to/your/project
...
- Searches `~/Projects/LifeOS-AGY/.agents/skills/Telos/` for `.md` files
- Searches `~/Projects/LifeOS-AGY/.agents/skills/Telos/data/` for `.csv` files
