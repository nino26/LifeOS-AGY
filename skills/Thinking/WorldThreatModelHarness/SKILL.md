...
curl -s -X POST http://localhost:8888/notify \
  ...
  -d '{"message": "Running WORKFLOW_NAME in the World Threat Model Harness", "voice_id": "21m00Tcm4TlvDq8ikWAM"}'
```

## Customization Check

Before execution, check for user customizations at:
`~/Projects/LifeOS-AGY/PAI/USER/SKILLCUSTOMIZATIONS/WorldThreatModelHarness/`
