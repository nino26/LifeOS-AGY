...
`~/Projects/LifeOS-AGY/PAI/USER/SKILLCUSTOMIZATIONS/CreateSkill/`
...
**Before creating ANY skill, READ:** `~/Projects/LifeOS-AGY/PAI/SkillSystem.md`

**Canonical example to follow:** `~/Projects/LifeOS-AGY/.agents/skills/Research/SKILL.md`
...
**See:** `~/Projects/LifeOS-AGY/PAI/SkillSystem.md` (Flat Folder Structure section)
...
**See:** `~/Projects/LifeOS-AGY/PAI/SkillSystem.md` (Dynamic Loading Pattern section)
