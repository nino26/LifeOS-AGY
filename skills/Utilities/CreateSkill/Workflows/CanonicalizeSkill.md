...
```
~/Projects/LifeOS-AGY/PAI/SkillSystem.md
```
...
```bash
~/Projects/LifeOS-AGY/.agents/skills/[skill-name]/SKILL.md
```
...
```bash
cp -r ~/Projects/LifeOS-AGY/.agents/skills/[skill-name]/ ~/Projects/LifeOS-AGY/History/Backups/[skill-name]-backup-$(date +%Y%m%d)/
```

**Note:** Backups go to `~/Projects/LifeOS-AGY/History/Backups/`, NEVER inside skill directories.
...
cd ~/Projects/LifeOS-AGY/.agents/skills/[SkillName]/Workflows/
...
find ~/Projects/LifeOS-AGY/.agents/skills/[SkillName]/ -type d -mindepth 2 -maxdepth 3
```
