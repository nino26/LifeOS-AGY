...
1. Read the skill system documentation: `~/Projects/LifeOS-AGY/PAI/SkillSystem.md`
2. Read the canonical example: `~/Projects/LifeOS-AGY/.agents/skills/Research/SKILL.md`
...
**Example:**
```bash
mkdir -p ~/Projects/LifeOS-AGY/.agents/skills/YourSkill/Workflows
mkdir -p ~/Projects/LifeOS-AGY/.agents/skills/YourSkill/Tools
```
...
**Full documentation:** `~/Projects/LifeOS-AGY/PAI/THENOTIFICATIONSYSTEM.md`
...
**Reference:** `~/Projects/LifeOS-AGY/PAI/CliFirstArchitecture.md` (Workflow-to-Tool Integration section)

**Examples (TitleCase):**
```bash
touch ~/Projects/LifeOS-AGY/.agents/skills/YourSkill/Workflows/UpdateDaemonInfo.md
touch ~/Projects/LifeOS-AGY/.agents/skills/YourSkill/Workflows/UpdatePublicRepo.md
touch ~/Projects/LifeOS-AGY/.agents/skills/YourSkill/Workflows/Create.md
touch ~/Projects/LifeOS-AGY/.agents/skills/YourSkill/Workflows/Publish.md
```
