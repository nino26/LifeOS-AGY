...
```bash
# Create new use case
bun run ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/EvalServer/cli.ts use-case create --name <name>

# List all use cases
bun run ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/EvalServer/cli.ts use-case list

# Show use case details
bun run ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/EvalServer/cli.ts use-case show <name>
```
...
bun run ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/EvalServer/cli.ts test-case add --use-case <name>

# List test cases for use case
bun run ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/EvalServer/cli.ts test-case list --use-case <name>
```
...
bun run ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/EvalServer/cli-run.ts --use-case <name> [--model <model>]
```
...
```bash
cd ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/EvalServer
...
```
~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/
├── UseCases/
│   └── <name>/
