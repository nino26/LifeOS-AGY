...
`~/Projects/LifeOS-AGY/PAI/USER/SKILLCUSTOMIZATIONS/Evals/`
...
```bash
# Run an eval suite
bun run ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/Tools/AlgorithmBridge.ts -s <suite>

# Log a failure for later conversion
bun run ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/Tools/FailureToTask.ts log "description" -c category -s severity

# Convert failures to test tasks
bun run ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/Tools/FailureToTask.ts convert-all

# Manage suites
bun run ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/Tools/SuiteManager.ts create <name> -t capability -d "description"
bun run ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/Tools/SuiteManager.ts list
bun run ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/Tools/SuiteManager.ts check-saturation <name>
bun run ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/Tools/SuiteManager.ts graduate <name>
```
...
bun run ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/Tools/AlgorithmBridge.ts -s regression-core -r 3 -u
```
