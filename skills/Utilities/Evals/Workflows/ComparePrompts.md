...
```bash
# Check prompts exist
ls ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/UseCases/<name>/prompts/
...
Create `~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/UseCases/<name>/comparisons/<comparison-name>.yaml`:
...
bun run ~/Projects/LifeOS-AGY/Templates/Tools/RenderTemplate.ts \
  ...
  -d ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/UseCases/<name>/comparisons/<name>.yaml \
  -o ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/UseCases/<name>/comparisons/<name>-setup.md \
  --preview
```
