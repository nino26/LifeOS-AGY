...
```bash
mkdir -p ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/UseCases/<name>/{test-cases,golden-outputs,prompts}
```

### Step 3: Create Config File

Create `~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/UseCases/<name>/config.yaml`:
...
Create `~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/UseCases/<name>/prompts/v1.0.0.md`:
...
Create test cases in `~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/UseCases/<name>/test-cases/`:
...
Create `~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/UseCases/<name>/README.md`:
...
\`\`\`bash
bun run ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/EvalServer/cli-run.ts --use-case <name>
\`\`\`
...
```bash
# Check structure
ls -la ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/UseCases/<name>/
