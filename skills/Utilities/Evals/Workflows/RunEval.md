...
ls ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/UseCases/<use-case>/config.yaml
```
...
```bash
cd ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/EvalServer && bun run dev &
```
