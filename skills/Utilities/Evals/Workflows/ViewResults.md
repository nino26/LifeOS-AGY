...
bun run ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/EvalServer/cli.ts results \
  --use-case <name> \
  --latest
```
...
bun run ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/EvalServer/cli.ts report \
  --run-id <run-id> \
  --output ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/Results/<use-case>/<run-id>/report.md
```
...
bun run ~/Projects/LifeOS-AGY/Templates/Tools/RenderTemplate.ts \
  -t Evals/Report.hbs \
  -d ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/Results/<use-case>/<run-id>/results.yaml \
  -o ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/Results/<use-case>/<run-id>/report.md
```
...
```bash
bun run ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/EvalServer/cli.ts compare \
  --run-a <run-id-1> \
  --run-b <run-id-2>
```
...
```bash
bun run ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Evals/EvalServer/cli.ts trend \
  --use-case <name> \
  --days 30
```
