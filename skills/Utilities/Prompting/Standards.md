...
**Location:** `~/Projects/LifeOS-AGY/.agents/skills/Utilities/Fabric/Patterns/`
...
```bash
~/Projects/LifeOS-AGY/.agents/skills/Utilities/Fabric/Tools/update-patterns.sh
```
...
All templates live in `~/Projects/LifeOS-AGY/.agents/skills/Utilities/Prompting/Templates/`:
...
**CLI Usage:**
```bash
bun ~/Projects/LifeOS-AGY/.agents/skills/Utilities/Prompting/Tools/RenderTemplate.ts \
...
**Programmatic Usage:**
```typescript
import { renderTemplate } from '~/Projects/LifeOS-AGY/.agents/skills/Utilities/Prompting/Tools/RenderTemplate.ts';
