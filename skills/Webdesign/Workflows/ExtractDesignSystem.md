...
```bash
bun ~/Projects/LifeOS-AGY/.agents/skills/Webdesign/Tools/DriveClaudeDesign.ts upload "$TMP"
```
...
```bash
bun ~/Projects/LifeOS-AGY/.agents/skills/Webdesign/Tools/DriveClaudeDesign.ts screenshot "$OUT/extracted-system.png"
```
...
```bash
bun ~/Projects/LifeOS-AGY/.agents/skills/Webdesign/Tools/DriveClaudeDesign.ts export tokens "$OUT/tokens.json"
```
